...
<html>
<head>
	<title>Q' HANDCRAFT | Corporate Business Design</title>
	<!--fonts-->
						...
						<div class="banner-info banner_width">
							<div class="col-lg-7 col-md-7 col-sm-7">
								<div class="banner_image">
									<img src="images/handcraft_macpro.png" alt="Q'HANDCRAFT" class="image_size" style="max-width:none;">
								</div>
							</div>
				...
				<div class="wrapper">
					...
					<div class="section s2 extra-padding">
						<div class="container">
							...
							<div class="row">
								<div class="col-md-8">
									<a class="popup-link" href="images/handcraft_show.jpg">
										<img src="images/handcraft_show.jpg" alt="Q'HANDCRAFT" class="img_shadow">
									</a>
